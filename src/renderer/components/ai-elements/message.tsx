...
export const MessageContent = ({
  ...
  <div
    className={cn(
      ...
      "group-[.is-user]:ml-auto group-[.is-user]:bg-[var(--bg-subtle)] group-[.is-user]:border group-[.is-user]:border-[var(--border-default)] group-[.is-user]:px-4 group-[.is-user]:py-3 group-[.is-user]:text-foreground",
